...
function decider(deviceName,data)
{
          let query = `insert into devices(name,condi,status) values('${deviceName}','${deviceCondition}','${deviceStatus}');`
          
          let basicProps = ['status','condition','name']
          let extendedProps = ["temperature","volume"]
          console.log(getDeviceProps(deviceName,availableDevices,basicProps,extendedProps))
