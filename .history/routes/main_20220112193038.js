...
{
          let query;// update devices set condi = operational, where id = deviceId
          ...
          {
                    query = `alter table devices modify column ( ) values('${deviceName}','${data.condition}',${data.status},${data.volume})`
          }
