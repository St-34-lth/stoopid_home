...
// Handles the add device page events. Calls the option disabler and updateVolume/Luminosity event handlers when fired( This is ensure values reset on device change )
