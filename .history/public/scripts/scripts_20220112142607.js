          ...
          for(device in availableDevices)
          {
                    ...
                    if(availableDevices[device].name==deviceName)
                    {
                              ...
                              deviceProperties.forEach((deviceProperty)=>
                              {
                                        ...
                                        // if(value !=undefined) 
                                        // {
                                        formattedProperty = validatePropertyValues(deviceProperty,value)
                                        if(formattedProperty==false)
                                        {
                                        ...
                                        {
                                                  console.log(typeof formattedProperty)
                                                  return validInput(deviceFormElements,formattedProperty)
                                        }
...
// returns false if there are empty values or incorrect types, otherwise the formatted value ready to be passed to the database.
function validatePropertyValues(deviceProperty,propertyValue)
{
          ...
          if(deviceProperty == "temperature")
          {
                    ...
                    // conversion here
                    if(typeof propertyValue == "number" && !isNaN(propertyValue)) return propertyValue
