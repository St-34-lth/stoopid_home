...
{
          let hasNot = ["temperature","volume","status","condition"]
          ...
          {                   
                    ...
                    {// unpack the options from the list of availableDevices for the particular device the user selects
                              ...
                              // disabledOpts = hasOptions.filter(item=> hasNot.includes(item)) 
                              let disabledOpts = hasNot.filter(item=>hasOptions.includes(item))
                              console.log(disabledOpts)
                              // for (opt in hasOptions)
                              // {         if( elmts.namedItem(hasOptions[opt])) 
                              //           {
                              //                    console.log(elmts.namedItem(hasOptions[opt]))
