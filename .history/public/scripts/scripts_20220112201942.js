...
function dialogueWindow(e)
{
          ...
          if(confirm("Are you sure?")) console.log(e.formTarget)
...
function validateUpdateForm(availableDevices,formID)
{
          ...
          return validInput(deviceFormName)          
...
function validateRegisterDevice(deviceName,deviceFormElements,availableDevices)
{
          ...
          for(device in availableDevices)
          {
                    ...
                    if(availableDevices[device].name==deviceName)
                    {
                              ...
                              return validInput("registerDevice")
...
function validInput(callerFormName,inputElement)
{
