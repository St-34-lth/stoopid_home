...
function validateUpdateForm(availableDevices,formID)
{
          ...
          for(d of deviceProps.deviceProperties)
          {
                    ...
                    if(!validatePropertyValues(deviceProperty,deviceProperty.value))
                    {
                              return wrongInput(devicePropery,deviceProperty.name)
                    }
                    else 
                    {
                              console.log(true)
                    ...
                    // console.log(deviceFormElement[d].value,deviceProps.deviceProperties[d])
          }
