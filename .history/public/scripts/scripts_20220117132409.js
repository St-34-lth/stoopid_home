...
// Helper function that checks if a device property's value is within allowable range.
// Takes in the device property's name, the restrictions applicable and the user given value.
// returns false if values within range true otherwise. 
...
// Validates user entries for given device properties.
// Takes in a deviceProperty name and its value. 
// Returns false if the value is empty or of an incorrect type, otherwise true.
