...
function optionDisabler(selection,elmts,availableDevices)
{
          ...
          {                   
                    ...
                    deviceOptions = availableDevices[d].options  
          }
          ...
          {
                    if (deviceOptions[i]!=undefined)
                    {
                              if (availOptions[i].name == deviceOptions[i] )
                              {
                                        //hasOptions.push(availOptions[i])
                                        availOptions[i].disabled=false
                              }
                              else console.log(availOptions[i].name) // doesNothave.push(availOptions[i])s
                    }

                    // console.log(availOptions[i].name)
                    // console.log(deviceOptions[i])
                    ...
                    //           s.disabled=false
                    // }
                    // if (elmts[availOptions[i]])
                    // {
                    //           elmts[d].disabled=false 
                    // }
                    
                    
                    // {
                    //           elmts[deviceOptions[i]].disabled = false 
                    // } 
                    // else if (deviceOptions[i]==undefined)
                    // {
                    //           console.log(elmts[i])
                    // }
          }
