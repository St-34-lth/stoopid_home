...
function optionDisabler(selection,elmts,availableDevices)
{
          ...
          {         
                    ...
                    if( elmts.namedItem(deviceProperty)) 
                    {
                              ...
                              {
                                        let openCloseradioDiv = elmts.namedItem(deviceProperty).parentElement.parentElement.hidden=false
          ...
          for (i in disabledProperties)
          {
                    ...
                    if(elmts.namedItem(disabledProperty))
                    {
                              ...
                              {
                                        let openCloseradioDiv = elmts.namedItem(disabledProperty).parentElement.parentElement.hidden=true
