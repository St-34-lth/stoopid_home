...
function validateUpdateDevice(availableDevices,formID)
{
          ...
          for(deviceProperty of deviceProperties)
          {
                    ...
                    if(deviceProperty=="openclose") 
                    {
                              ...
                              let openClosedadioDiv = deviceFormElement.namedItem(deviceProperty).parentElement.parentElement.hidden=true
                              
                    }
                    else 
                    {
                             propertyElement = deviceFormElements[deviceProperty]
