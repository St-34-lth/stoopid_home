...
function optionDisabler(selection,elmts,availableDevices)
{
          ...
          // {
          //           for(elmt in availOptions)
          //           {
          //                     if (availOptions[elmt].name==deviceOptions[opt])
          //                     {
          //                               availOptions[elmt].disabled = false  
          //                     }
          //                     else availOptions[elmt].disabled=true
          ...
          // }
                    ...
                    // else availOptions[opt].disabled = true 
}
