...
{
          let basicProperties = basicProps.length > 0 && basicProps!=undefined ? basicProps : ["status","condition"] 
          let extraProperties = extraProps.length > 0 && extraProps!=undefined? extraProps : ["temperature","volume"] 
