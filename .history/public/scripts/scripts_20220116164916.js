...
function getdeviceListings(optionAssets,deviceAssets)
{
          ...
          {
                    let imgElmt= deviceListingsCollection[0]
                    ...
                    switch(propertyID[0])
                    {
                              ...
                              case "device":
                                        console.log(imgElmt.name,propertyID[0])
                                        console.log(imgElmt.id,propertyID[0])
                                        assignDeviceAssets(imgElmt.name,deviceAssets)
                                        break;
                              case "status":
...
function assignDeviceAssets(deviceName,deviceAssets)
{
          
          // document.getElementById(`${deviceName}`+'Image').src = deviceAssets[deviceName]
          console.log(deviceAssets[deviceName])
          console.log( document.getElementsByName(deviceName).src)
          = '/svgs/add-device-svgrepo-com.svg'
}
