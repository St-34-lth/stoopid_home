...
function optionDisabler(selection,elmts,availableDevices)
{
          ...
          // find which device the user has selected and get its options
          ...
          {                   
                    ...
                    {// unpack the options from the list of availableDevices for the particular device the user selects
                              ...
                              {         if( elmts[hasOptions[opt]]) 
                                        {
                                                  console.log(elmts[hasOptions[opt]])
                                                  // elmts[opt].disabled=false
                                        } else  console.log(elmts[hasOptions[opt]])// elmts[opt].disabled = true 
                              }
                              break; 
                    }
          ...
          // now i need to figure out a way to make everything else disabled
          // hasOptions =[]
          // doesNothave=[]
          // for (i in availOptions)
          // {
          //           if (hasOptions[i]!=undefined)
          //           {
          //                     // the issue is with status - there are two entries.
          //                     // perhaps remove from all devices what is globally available - status,condition !
          //                     availOptions[hasOptions[i]].disabled = false 
                              
          //                     // {
                                        
                                        
          //                     //           // hasOptions.push(availOptions[i])
          //                     //           // availOptions[i].disabled=false
          //                     //           console.log(availOptions[i].name,deviceOptions[i])
          //                     // }
          //                     // else   console.log(availOptions[i].name,deviceOptions[i]) // doesNothave.push(availOptions[i])s
          //           }
          ...
          // console.log(hasOptions,doesNothave)  
