...
function validateUpdateForm(availableDevices,formID)
{
          ...
          for(deviceProperty of deviceProperties)
          {
                    propertyElement = deviceFormElement[deviceProperty]
                    
                    
                    if (deviceProperty =='temperature' || deviceProperty=='status')
                    {
                              
                              restrictedValue = checkPropertyValues(deviceProperty,deviceRestrictions,propertyElement.value)
                    }
