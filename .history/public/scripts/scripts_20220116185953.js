...
function updateVolumeEventListener(e,value)
{
          ...
          if(value==undefined) e.nextElementSibling// document.getElementById('volumeValueContainer').innerHTML= e.value
          // else document.getElementById('volumeValueContainer').innerHTML= value
...
function updateLuminosityEventListener(e,value)
{
          ...
          if(value==undefined) document.getElementById('luminosityValueContainer').innerHTML= e.value
          else document.getElementById('luminosityValueContainer').innerHTML=value
}
